"""
Entraînement identique à ``train_crops.py``, avec **équilibrage des classes** sur le train.
...
Les augmentations fortes (zoom, couleur, flou, erasing, translation — sans flip) et le
multiplicateur ``training.train_augment_repeats`` restent inchangés.

Lancer depuis ``src/``::

    python train_equilibre.py
    python train_equilibre.py experiment=cnn_lstm
"""
...
from models.cnntransformer import build_cnntransformer_model
...
def main(cfg: DictConfig) -> None:
    ...
    print(
        ...
        f"{train_augment_repeats} virtual repeats "
